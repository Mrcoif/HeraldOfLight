...
public class SignpostActor  extends Actor {
    ...
    public SignpostActor(){
            setX(startX);
            setY(startY);
            texture = new Texture(Gdx.files.internal("Crossroad/signpost.png"));
            setWidth(SCREEN_WIDTH);
            setHeight(SCREEN_HEIGHT - 100);
            boundary = new Rectangle(590, 230, 130, 365);
        }
